...
def main():
    ...
    # Get the user input for client details
    ...
    # Get the user input for appointment details
    ...
    # Get the user input for reminder details
    ...
    # Fetch and display all data above
